...
MVP 시연 중 자주 막히는 지점과 현재 구현상 제한사항을 정리합니다. 기준일은 2026-05-06이며, **NCP Seoul VM 실서버**(`http://101.79.17.196:8000`, 2vCPU 8GB) 배포 후 상태 기준으로 작성했습니다. 이전 HF Spaces 무료 플랜은 POST 콜드스타트로 부적합 → NCP로 이전.
